...
export class InternetbankingdetailsComponent implements OnInit {
  ...
  showDetails()
  {
    ...
    this.adminService.internetBankingCustomerDetails(this.datatransfer.getnum()).subscribe(response=>{
  ...
  ApproveInternetBanking()
  {
      ...
      console.log(this.datatransfer.getnum());
      this.adminService.updateInternetBankingStatus(this.datatransfer.getnum()).subscribe(response=>{
